...
<body class="ui-rounded sidebar-fill header-fill">
    ...
    <div class="main-container">
        ...
        <div class="content container-fluid">
            ...
            <div class="row my-3">
                <div class="container">
                    <div class="card has-background border-0 bg-default mb-3">
                    ...
                    <div class="card has-background border-0 bg-primary text-white mb-3">
                        <div class="background opacity-30">
                    ...
                    <div class="card has-background border-0 bg-default text-white mb-3">
                        <div class="background opacity-30">
                            <img src="../assets/img/image8.jpg" alt="">
                        </div>
                        <div class="card-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-inner">
                                    <h5 class="mb-0 font-weight-normal">
                                        <b>10%</b> instant discount<br>
                                        <small class="text-mute">on all Credit and Debit cards</small>
                                    </h5>
                                </div>
