                ...
                <div class="col-12 align-self-center">
                    <div class="row justify-content-center">
                        <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-3">
                            <h1 class="text-center font-weight-normal mb-5">Create new<br>account with us</h1>
                            ...
                            <a href="signin.jsp" class="btn btn-lg btn-default btn-block my-4">Sign up</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 align-self-end mb-4 text-center">
                    Already have account?<br><a href="signin.jsp" class="text-dark font-weight-bold">Sign in</a> here.
                </div>
            </div>
        </div>
    </div>
