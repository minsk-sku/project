...
<body class="ui-rounded sidebar-fill header-fill">
    ...
    <div class="main-container">
                    ...
                    <div class="col-12 align-self-center">
                        <div class="chat-list scroll-y">
                            <div class="row no-margin left-chat">
                                ...
                                <div class="col-12">
                                    <p class="text-mute small mt-1 pl-3">9:00 pm</p>
                                </div>
                            </div>
                            <div class="row no-margin right-chat">
                                ...
                                <div class="col-12 text-right">
                                    <p class="text-mute small mt-1 pr-3"><i class="material-icons h6 my-0 vm text-info mr-1">done_all</i>9:10 pm</p>
                                </div>
                            </div>
                            <div class="row no-margin pt-2 pb-4">
                                <div class="col-12  text-center">
                                    <span class="bg-light-primary mx-auto btn btn-sm text-primary py-1">26 November 2019</span>
                                </div>
                            </div>
                            <div class="row no-margin left-chat">
                                <div class="col-12">
                                    <div class="chat-block">
                                        <div class="row">
                                            <div class="col">
                                                How are you? Mobileshop we were wait since long to be here.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <p class="text-mute small mt-1 pl-3">8:00 pm</p>
                                </div>
                            </div>
                            <div class="row no-margin right-chat">
                                <div class="col-12">
                                    <div class="chat-block">
                                        <div class="row">
                                            <div class="col">
                                                How are you? Mobileshop we were waited since long to be here.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 text-right">
                                    <p class="text-mute small mt-1 pr-3"><i class="material-icons h6 my-0 vm text-info mr-1">done_all</i>8:00 pm</p>
                                </div>
                            </div>
                            <div class="row no-margin pt-2 pb-4">
                                <div class="col-12  text-center">
                                    <span class="bg-light-primary mx-auto btn btn-sm text-primary py-1">25 November 2019</span>
                                </div>
                            </div>
                            <div class="row no-margin left-chat">
                                <div class="col-12">
                            ...
                            <div class="row no-margin right-chat">
                                <div class="col-12">
                                    <div class="chat-block">
                                        <div class="row">
                                            <div class="col">
                                                <p>Mobileshop is HTML template can be used in various business domains like Manufacturing, inventory, IT, administration etc. for mobile application for news and broadcasting </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 text-right">
                                    <p class="text-mute small mt-1 pr-3"><i class="material-icons h6 my-0 vm text-info mr-1">done</i>8:00 pm</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="tabs-footer p-3">
            <div class="input-group">
                <div class="input-group-prepend">
                    <button class="btn btn-default px-3" type="button"><i class="material-icons h6 my-0">insert_emoticon</i></button>
                </div>
                <input type="text" class="form-control" placeholder="Your message">
                <div class="input-group-append">
                    <button class="btn btn-default px-3" type="button"><i class="material-icons h6 my-0">send</i></button>
                </div>
            </div>
        </footer>
    </div>
