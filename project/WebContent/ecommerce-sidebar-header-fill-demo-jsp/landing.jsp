        ...
        <div class="login-container">
            <div class="row no-gutters">
                ...
                <div class="col-12 align-self-center">
                    <div class="row justify-content-center">
                        <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-3 text-center">
                            ...
                            <h2 class="text-uppercase font-weight-medium">Mobileshop</h2>
                ...
                <div class="col-12 align-self-end mb-4 text-center">
                    <div class="row">
                        <div class="col">
                            <a href="signup.jsp" class="btn btn-lg btn-default btn-block">Sign up</a>
                        </div>
                        <div class="col">
                            <a href="signin.jsp" class="btn btn-lg btn-white btn-block">Sign in</a>
                        </div>
                    </div>
                </div>
            </div>
