                ...
                <div class="col-12 align-self-center">
                    <div class="row justify-content-center">
                        <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-3 text-center">
                            <h1 class="text-center font-weight-normal mb-3">Sorry to be here!<br>Reset password</h1>
                            ...
                            <a href="signin.jsp" class="btn btn-lg btn-default btn-block my-4">Reset Password</a>
                        </div>
                    </div>
                </div>
