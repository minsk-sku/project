                    ...
                    <div class="row my-3">
                        <div class="container">
                            <div class="list-group">
                                <a href="alert.jsp" class="list-group-item list-group-item-action">Alert <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="avatar.jsp" class="list-group-item list-group-item-action">Avatar <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="buttons.jsp" class="list-group-item list-group-item-action">Buttons <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="card.jsp" class="list-group-item list-group-item-action">Card <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="collapse.jsp" class="list-group-item list-group-item-action">Collapse <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="carousel.jsp" class="list-group-item list-group-item-action">Carousel <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="inputgroup.jsp" class="list-group-item list-group-item-action">Input Group <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="listgroup.jsp" class="list-group-item list-group-item-action">List Group <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="modal.jsp" class="list-group-item list-group-item-action">Modal <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="popover.jsp" class="list-group-item list-group-item-action">Popover <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="progress.jsp" class="list-group-item list-group-item-action">Progress <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="spinners.jsp" class="list-group-item list-group-item-action">Spinner <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                                <a href="switch.jsp" class="list-group-item list-group-item-action">Switch <div class="text-mute float-right"><i class="material-icons">arrow_forward</i></div></a>
                            </div>
                        </div>
                    </div>
                </div>
