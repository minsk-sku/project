        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="container my-3">
                    <div class="card  mb-3">
                        <div class="card-body">
                            <div class="avatar avatar-20 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-40 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-60 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-80 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-100 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-120 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-140 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-160 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-180 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
                            <div class="avatar avatar-200 m-1 has-background">
                                <figure class="background">
                                    <img src="../assets/img/image4.jpg" alt="">
                                </figure>
                            </div>
