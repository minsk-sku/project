                ...
                <div class="container my-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card  mb-3">
                                <div class="card-header border-0 bg-none">
                                    <div class="row">
                                        <div class="col-9">
                                            <p class="fs15">Dismissable Alerts</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card  mb-3">
                                <div class="card-header border-0 bg-none">
                                    <div class="row">
                                        <div class="col-9">
                                            <p class="fs15">Icons with Alerts</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-primary" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a primary alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-secondary" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a secondary alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-success" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a success alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-danger" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a danger alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-warning" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a warning alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-info" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a info alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-light" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a light alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                                    <div class="alert alert-dark" role="alert">
                                        <i class="material-icons mr-2">warning</i>This is a dark alert!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <i class="material-icons">close</i>
                                        </button>
                                    </div>
                    ...
                    <div class="card  mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert border-secondary text-secondary" role="alert">
                                <i class="material-icons mr-2">warning</i>This is a secondary alert!
                            ...
                            <div class="alert border-warning text-warning" role="alert">
                                <i class="material-icons mr-2">warning</i>This is a warning alert!
                                <button type="button" class="close text-warning" data-dismiss="alert" aria-label="Close">
                                    <i class="material-icons">close</i>
                                </button>
                            </div>
                            <div class="alert border-info text-info" role="alert">
                                <i class="material-icons mr-2">warning</i>This is a info alert!
                                <button type="button" class="close text-info" data-dismiss="alert" aria-label="Close">
                                    <i class="material-icons">close</i>
                                </button>
                            </div>
                            <div class="alert border-light text-light" role="alert">
                                <i class="material-icons mr-2">warning</i>This is a light alert!
                                <button type="button" class="close text-light" data-dismiss="alert" aria-label="Close">
                                    <i class="material-icons">close</i>
                                </button>
                            </div>
                            <div class="alert border-dark text-dark" role="alert">
                                <i class="material-icons mr-2">warning</i>This is a dark alert!
