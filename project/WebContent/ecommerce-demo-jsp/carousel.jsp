        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="container my-3">
                    <div id="carouselExampleIndicators" class="carousel slide bg-default" data-ride="carousel">
                ...
                <div class="container my-3">
                    <div id="carouselExampleIndicators2" class="carousel slide bg-default" data-ride="carousel">
                        <ol class="carousel-indicators">
